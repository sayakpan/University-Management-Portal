...
public class Student {
    ...
    public Student(){
        ...
        try {
            ...
            conn = DriverManager.getConnection("jdbc:mysql://localhost/Student1","root","");
    ...
    String fas = mfa.getText().toString();
           try {
            ...
            while (res.next()) {
                ...
                String qry = "INSERT INTO `result` (`stdid`, `oop`, `dld`, `isl`, `eng`, `fa`) VALUES ('"+sid+"', '"+oops+"', '"+dlds+"', '"+isls+"', '"+engs+"', '"+fas+"')";
...
String columnName[]={"Reg No","Student Name","Father Name","Department","Semester","OOP","DLD","Islamiyat","English","Financial Accouting"};
...
protected void showres() throws SQLException {
    ...
    res = state.executeQuery("select student.regno as reg,student.name as name, student.fname as fname, student.department as dep,student.semester as sem, result.oop as soop, result.dld as sdld, result.isl as sisl, result.eng as seng, result.fa as sfa from student join result on student.id=result.stdid");
    String sname = "";
    String sfname = "";
    String sreg = "";
    String sdep = "";
...
public void addstd() {
    ...
    add.addActionListener(new ActionListener(){
        ...
        public void actionPerformed(ActionEvent arg0) {
           ...
           try {
            String querry = "INSERT INTO `student` (`id`, `regno`, `name`, `fname`, `department`, `semester`) VALUES (NULL, '"+regno+"', '"+n+"', '"+fn+"', '"+d+"', '"+s+"')";
...
public static void main(String[] args) {
    ...
    index.setDefaultCloseOperation(index.EXIT_ON_CLOSE);
   }
